...
import { canBeNumberChar } from "./Expand_Basics.js";
import { arrayDiff, arrayEqual, arrayHasDiff } from "./Expand_List.js";
...
// open * 按键记录器 keyNotbook (组合键监听) * open
...
// end  * 按键记录器 keyNotbook (组合键监听) * end 


// open * dom resize 事件 * open
...
// end  * dom 自定义事件 (event) * end 

// open * 添加自定义事件 (event) * open
